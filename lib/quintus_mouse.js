...
Quintus.Mouse = function(Q) {
  ...
  Q.Evented.extend("MouseSystem",{
    ...
    normalizeMouse: function(touch,stage) {
      ...
      this.mousePos.p.ox = this.mousePos.p.px = posX / Q.cssWidth * Q.width;
      this.mousePos.p.oy = this.mousePos.p.py = posY / Q.cssHeight * Q.height;
    ...
    move: function(mouse) {
      for(var stageIdx=0;stageIdx < mouseStage.length;stageIdx++) {
        ...
        var pos = this.normalizeMouse(mouse,stage);
        ...
        if(obj){
          if(this.enteredObject !== obj && this.enteredObject !== null){
             this.enteredObject.trigger('mouseExit',{
                //TODO: info here
              });
             this.enteredObject == null;
          ...
          if(this.enteredObject !== obj) {
            ...
            this.enteredObject.trigger('mouseEnter',{
              //TODO: Info here
            });
          }
